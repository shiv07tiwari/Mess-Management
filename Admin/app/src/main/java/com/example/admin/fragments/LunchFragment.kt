...
class LunchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView.l_everyday.text = strtext[0].fixedMenu
        rootView.l_monday.text = strtext[0].mondayMenu
        rootView.l_tuesday.text = strtext[0].tuesdayMenu
        rootView.l_wednesday.text = strtext[0].wednesdayMenu
        rootView.l_thursday.text = strtext[0].thursdayMenu
        rootView.l_friday.text = strtext[0].fridayMenu
        rootView.l_saturday.text = strtext[0].saturdayMenu
        rootView.l_sunday.text = strtext[0].sundayMenu
        ...
        return (when (item.itemId) {
            R.id.menuEditWeekly -> {
                ...
                dialog.dialogButton_menu.setOnClickListener {
                    ...
                    val sharedPref = this@LunchFragment.activity?.getSharedPreferences("name", Context.MODE_PRIVATE)
                    ...
                    var m = MessMenu(2,dialog.update_everyday.text.toString(),dialog.update_monday.text.toString(),
                    ...
                    call.enqueue(object : retrofit2.Callback<String> {
                        ...
                        override fun onResponse(call: Call<String>, response: Response<String>) {
                            ...
                            try {
                                ...
                                Toast.makeText(this@LunchFragment.activity,"Updated Successfully !",
